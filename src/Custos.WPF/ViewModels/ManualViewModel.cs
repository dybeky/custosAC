...
public partial class ManualViewModel : ViewModelBase
{
    ...
    private void OpenDataUsage()
    {
        try
        {
            ...
            StatusMessage = "Data Usage settings opened";
        }
        catch (Exception ex)
        {
    ...
    private void OpenVideos()
    {
        try
        {
            ...
            if (Directory.Exists(videosPath))
            {
                ...
                StatusMessage = "Videos folder opened";
            }
            else
            {
    ...
    private void OpenDownloads()
    {
        try
        {
            ...
            if (Directory.Exists(downloadsPath))
            {
                ...
                StatusMessage = "Downloads folder opened";
            }
            else
            {
    ...
    private void OpenLocalAppData()
    {
        try
        {
            ...
            StatusMessage = "LocalAppData folder opened";
        }
        catch (Exception ex)
        {
    ...
    private void OpenPrefetch()
    {
        try
        {
            ...
            if (Directory.Exists(prefetchPath))
            {
                ...
                StatusMessage = "Prefetch folder opened";
            }
            else
            {
    ...
    private async Task OpenRegistryAtAsync(string registryPath, string name)
    {
        try
        {
            ...
            StatusMessage = $"Registry ({name}) opened";
        }
        catch (Exception ex)
        {
    ...
    private void OpenOneDrive()
    {
        try
        {
            ...
            if (Directory.Exists(oneDrivePath))
            {
                ...
                StatusMessage = "OneDrive folder opened";
            }
            else
            {
    ...
    private void OpenTelegramUndead()
    {
        try
        {
            ...
            StatusMessage = "Telegram @undeadsellerbot opened";
        }
        catch (Exception ex)
        {
    ...
    private void OpenTelegramMelony()
    {
        try
        {
            ...
            StatusMessage = "Telegram @MelonySolutionBot opened";
        }
        catch (Exception ex)
        {
            StatusMessage = $"Failed to open Telegram: {ex.Message}";
    ...
    private void OpenWindowsDefender()
    {
        try
        {
            ...
            StatusMessage = "Windows Defender opened";
        }
        catch
        {
            ...
            try
            {
                ...
                StatusMessage = "Windows Security opened";
            }
            catch (Exception ex)
            {
