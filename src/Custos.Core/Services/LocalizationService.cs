...
public class LocalizationService : INotifyPropertyChanged
{
    ...
    private readonly LocalizedStrings _englishStrings = new()
    {
        // Settings
        Settings = "Settings",
        SettingsSubtitle = "Configure custos preferences",
        Updates = "Updates",
        ...
        DeleteAfterUseDesc = "Automatically delete custos when you close it",
        ...
        UpdateRequiredMessage = "A new version is required to continue using the application",
        CloseApp = "CLOSE",
    ...
    private readonly LocalizedStrings _russianStrings = new()
    {
        // Settings
        Settings = "Настройки",
        SettingsSubtitle = "Настройка параметров custos",
        Updates = "Обновления",
        ...
        DeleteAfterUseDesc = "Автоматически удалить custos при закрытии",
        ...
        UpdateRequiredMessage = "Для продолжения работы необходимо обновить приложение",
        CloseApp = "ЗАКРЫТЬ",
