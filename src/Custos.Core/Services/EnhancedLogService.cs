...
public class EnhancedLogService : IDisposable
{
    ...
    public EnhancedLogService(string? logDirectory = null)
    {
        ...
        LogInfo(LogCategory.General, "=== Custos Enhanced Logging Started (Memory Only) ===");
    ...
    private async Task RotateLogFileAsync()
    {
        try
        {
            ...
            var rotatedPath = Path.Combine(_logDirectory, $"Custos_Enhanced_{timestamp}_rotated.log");
            ...
            var logFiles = Directory.GetFiles(_logDirectory, "Custos_Enhanced_*.log")
    ...
    public void Dispose()
    {
        ...
        LogInfo(LogCategory.General, "=== Custos Enhanced Logging Ended ===");
